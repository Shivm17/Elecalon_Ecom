        ...
        <React.Fragment>
            ...
            <header>
                <div className="container header-content">
                    <div className="logo">
                        <i className="fas fa-robot"></i> Elecalon Ecom OPC
                    </div>
                    <nav>
                        <ul>
                        ...
                        <div className="pricing-card">
                            ...
                            <div className="pricing-footer">
                                <div className="razorpay-btn">
                                    <form>
                                        {/* Script tags must be included as raw HTML using dangerouslySetInnerHTML */}
                                        <div 
                                            dangerouslySetInnerHTML={{
                                                __html: '<script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_RJqSSTvvppus4X" async></script>'
                                            }}
                                        />
                                    </form>
                                </div>
                            ...
                            <div className="pricing-footer">
                                <div className="razorpay-btn">
                                    <form>
                                        <div 
                                            dangerouslySetInnerHTML={{
                                                __html: '<script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_RJqQ7fdKZDVYHn" async></script>'
                                            }}
                                        />
                                    </form>
                                </div>
                            ...
                            <div className="pricing-footer">
                                <div className="razorpay-btn">
                                    <form>
                                        <div 
                                            dangerouslySetInnerHTML={{
                                                __html: '<script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_RJqROcYkgleO07" async></script>'
                                            }}
                                        />
                                    </form>
                                </div>
